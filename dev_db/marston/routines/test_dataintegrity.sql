BEGIN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laacasedetails_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laadefaulters_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   ...
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
				   LEFT JOIN marston.laadefaulters_20241018 AS c ON a.defaulterid = c.defaulterid
	...
	BEGIN
	    IF EXISTS (SELECT 1
	               FROM marston.laadefaultersemails_20241018 a
	               LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
	               LEFT JOIN marston.laadefaulters_20241018 AS c ON a.defaulterid = c.defaulterid
	               WHERE (b.caseid IS NULL OR c.defaulterid IS NULL) AND a.json_footer IS NULL) THEN
	        RAISE NOTICE 'Error: Orphaned records found in LAADefaultersEmails:';
	        PERFORM *
	        FROM marston.laadefaultersemails_20241018 AS a
	        LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
	        LEFT JOIN marston.laadefaulters_20241018 AS c ON a.defaulterid = c.defaulterid
	        WHERE (b.caseid IS NULL OR c.defaulterid IS NULL) AND a.json_footer IS NULL
	        ORDER BY b.loadedon DESC;
	...
	BEGIN
	    IF EXISTS (SELECT 1
	               FROM marston.laadefaultersphones_20241018 a
	               LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
	               LEFT JOIN marston.laadefaulters_20241018 AS c ON a.defaulterid = c.defaulterid
	               WHERE (b.caseid IS NULL OR c.defaulterid IS NULL) AND a.json_footer IS NULL) THEN
	        RAISE NOTICE 'Error: Orphaned records found in LAADefaultersPhones:';
	        PERFORM *
	        FROM marston.laadefaultersphones_20241018 AS a
	        LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
	        LEFT JOIN marston.laadefaulters_20241018 AS c ON a.defaulterid = c.defaulterid
	        WHERE (b.caseid IS NULL OR c.defaulterid IS NULL) AND a.json_footer IS NULL
	        ORDER BY b.loadedon DESC;
	...
	BEGIN
	    IF EXISTS (SELECT 1
	               FROM marston.laadefaulterscontactaddressesaudit_20241018 a
	               LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
	               LEFT JOIN marston.laadefaulters_20241018 AS c ON a.defaulterid = c.defaulterid
	               WHERE (b.caseid IS NULL OR c.defaulterid IS NULL) AND a.json_footer IS NULL) THEN
	        RAISE NOTICE 'Error: Orphaned records found in LAADefaultersContactAddressesAudit:';
	        PERFORM *
	        FROM marston.laadefaulterscontactaddressesaudit_20241018 AS a
	        LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
	        LEFT JOIN marston.laadefaulters_20241018 AS c ON a.defaulterid = c.defaulterid
	        WHERE (b.caseid IS NULL OR c.defaulterid IS NULL) AND a.json_footer IS NULL
	        ORDER BY b.loadedon DESC;
	...
	BEGIN
	    IF EXISTS (SELECT 1
	               FROM marston.laadefaultersemailsaudit_20241018 a
	               LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
	               LEFT JOIN marston.laadefaulters_20241018 AS c ON a.defaulterid = c.defaulterid
	               WHERE (b.caseid IS NULL OR c.defaulterid IS NULL) AND a.json_footer IS NULL) THEN
	        RAISE NOTICE 'Error: Orphaned records found in LAADefaultersEmailsAudit:';
	        PERFORM *
	        FROM marston.laadefaultersemailsaudit_20241018 AS a
	        LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
	        LEFT JOIN marston.laadefaulters_20241018 AS c ON a.defaulterid = c.defaulterid
	        WHERE (b.caseid IS NULL OR c.defaulterid IS NULL) AND a.json_footer IS NULL
	        ORDER BY b.loadedon DESC;
	...
	BEGIN
	    IF EXISTS (SELECT 1
	               FROM marston.laadefaultersphonesaudit_20241018 a
	               LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
	               LEFT JOIN marston.laadefaulters_20241018 AS c ON a.defaulterid = c.defaulterid
	               WHERE (b.caseid IS NULL OR c.defaulterid IS NULL) AND a.json_footer IS NULL) THEN
	        RAISE NOTICE 'Error: Orphaned records found in LAADefaultersPhonesAudit:';
	        PERFORM *
	        FROM marston.laadefaultersphonesaudit_20241018 AS a
	        LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
	        LEFT JOIN marston.laadefaulters_20241018 AS c ON a.defaulterid = c.defaulterid
	        WHERE (b.caseid IS NULL OR c.defaulterid IS NULL) AND a.json_footer IS NULL
	        ORDER BY b.loadedon DESC;
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laacasecharges_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laacasepayments_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laacasearrangements_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laacaseassignments_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laacaseholds_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laacasevisits_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laacaseadditionaldata_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laacaseattachments_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laacaselinks_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laacasenotes_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laacasehistory_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laacaseworkflow_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laacasecalllog_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laacasebalance_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laacaserefunds_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laadefaulterswelfare_20241018 AS a
                   LEFT JOIN marston.laacases_20241018 AS b ON a.caseid = b.caseid
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laalacesdatawarehouse_20241018 AS a
                   LEFT JOIN marston.laacasedetails_20241018  AS b ON a.maatid = b.clientcasereference
                   WHERE b.caseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laalacesdatawarehouse_20241018 AS a
                   LEFT JOIN marston.laalacescases_20241018 AS b ON a.lacescaseid = b.lacescaseid
...
BEGIN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laalacesassignments_20241018 AS a
                   LEFT JOIN marston.laalacescases_20241018 AS b ON a.lacescaseid = b.lacescaseid
                   WHERE b.lacescaseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laalacescasesactions_20241018 AS a
                   LEFT JOIN marston.laalacescases_20241018 AS b ON a.lacescaseid = b.lacescaseid
                   WHERE b.lacescaseid IS NULL AND a.json_footer IS NULL) THEN
	...
	BEGIN
	    IF EXISTS (SELECT 1
	               FROM marston.laalacesaudit_20241018 AS a
	               LEFT JOIN marston.laalacesdatawarehouse_20241018 AS b ON a.rowid = b.recordid
	...
	BEGIN
	    IF EXISTS (SELECT 1
	               FROM marston.laalacesaudit_20241018 AS a
	               LEFT JOIN marston.laalacescases_20241018 AS b ON a.rowid = b.lacescaseid
	...
	BEGIN
	    IF EXISTS (SELECT 1
	               FROM marston.laalacesaudit_20241018 AS a
	               LEFT JOIN marston.laalacesproperties_20241018 AS b ON cast(a.rowid as integer) = b.recordid
	        ...
	        PERFORM *
	        FROM marston.laalacesaudit_20241018 AS a
	        LEFT JOIN marston.laalacesproperties_20241018 AS b ON a.rowid = b.recordid
	        WHERE b.recordid IS NULL AND a.json_footer IS NULL
	        ORDER BY b.loadedon DESC;
	    END IF;
	EXCEPTION
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laalacesexperianentries_20241018 AS a
                   LEFT JOIN marston.laalacescases_20241018 AS b ON a.lacescaseid = b.lacescaseid
                   WHERE b.lacescaseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laalacesproperties_20241018 AS a
                   LEFT JOIN marston.laalacescases_20241018 AS b ON a.lacescaseid = b.lacescaseid
                   WHERE b.lacescaseid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laalaceslandregistryentries_20241018 AS a
                   LEFT JOIN marston.laalacesproperties_20241018 AS b ON a.propertyid = b.recordid
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laalaceslandregistryassociations_20241018 AS a
                   LEFT JOIN marston.laalaceslandregistryentries_20241018 AS b ON a.landregistryentryid = b.recordid
                   WHERE b.recordid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laalacesexperianmortgageentries_20241018 AS a
                   LEFT JOIN marston.laalacesexperianentries_20241018 AS b ON a.experianentryid = b.recordid
                   WHERE b.recordid IS NULL AND a.json_footer IS NULL) THEN
    ...
    BEGIN
        IF EXISTS (SELECT 1
                   FROM marston.laalacesexperianassociations_20241018 AS a
                   LEFT JOIN marston.laalacesexperianentries_20241018 AS b ON a.experianentriesrecordid = b.recordid
                   WHERE b.recordid IS NULL AND a.json_footer IS NULL) THEN
