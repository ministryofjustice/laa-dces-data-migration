...
-- It aggregates maximum loaded dates from `laacasenotes_20241203` and `laacasehistory_20241203`, and selects relevant `caseid`, `maatid`, and `lacescaseid` values from `laacasedetails_20241203`.
...
BEGIN
    ...
    LEFT JOIN marston.laalacesdatawarehouse_20241203 dwh ON dwh.maatid = a.clientcasereference
