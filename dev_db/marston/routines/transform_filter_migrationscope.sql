...
-- Records are filtered based on whether the case is open or if the latest activity date in case notes or history is later than January 31, 2023.
-- Additional criteria added to filter clientcasereference.
-- https://dsdmoj.atlassian.net/browse/DCES-564
