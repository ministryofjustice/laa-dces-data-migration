-- PROCEDURE: marston.load_transform1_tables()

-- DROP PROCEDURE IF EXISTS marston.load_transform1_tables();

CREATE OR REPLACE PROCEDURE marston.load_transform1_tables(
	)
LANGUAGE 'plpgsql'
AS $BODY$
DECLARE
...
END;
$BODY$;
ALTER PROCEDURE marston.load_transform1_tables()
    OWNER TO "cpSB74T20Z";