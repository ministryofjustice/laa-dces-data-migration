SELECT json_agg(
    json_build_object(
        ...
        'DOB', defendant.DOB,
        'NINO', defendant.NINO,
        'DefendantLoadedOn', defendant.LoadedOn,  -- Renamed and fixed typo
        ...
        'CASE-LINKS', (
            ...
            FROM (
                SELECT
                    caselinks.LinkID,
                    caselinks.LinkedCaseID,
                    cases2.clientcasereference,
                    caselinks.LoadedOn
                FROM marston.laacaselinks_20240916 caselinks
                JOIN marston.laacases_20240916 cases2 ON caselinks.caseid = cases2.caseid
