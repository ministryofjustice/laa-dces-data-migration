-- PROCEDURE: anonymised.copy_tables_to_anonymised()

-- DROP PROCEDURE IF EXISTS anonymised.copy_tables_to_anonymised();

CREATE OR REPLACE PROCEDURE anonymised.copy_tables_to_anonymised(
	)
LANGUAGE 'plpgsql'
AS $BODY$
DECLARE
...
END;
$BODY$;
ALTER PROCEDURE anonymised.copy_tables_to_anonymised()
    OWNER TO "cpSB74T20Z";
