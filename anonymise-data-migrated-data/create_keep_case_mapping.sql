-- PROCEDURE: anonymised.create_keep_case_mapping()

-- DROP PROCEDURE IF EXISTS anonymised.create_keep_case_mapping();

CREATE OR REPLACE PROCEDURE anonymised.create_keep_case_mapping(
	)
LANGUAGE 'plpgsql'
AS $BODY$
DECLARE
...
END;
$BODY$;
ALTER PROCEDURE anonymised.create_keep_case_mapping()
    OWNER TO "cpSB74T20Z";
