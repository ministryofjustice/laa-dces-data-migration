-- PROCEDURE: anonymised.anonymise_data()

-- DROP PROCEDURE IF EXISTS anonymised.anonymise_data();

CREATE OR REPLACE PROCEDURE anonymised.anonymise_data(
	)
LANGUAGE 'plpgsql'
AS $BODY$
DECLARE
...
END;
$BODY$;
ALTER PROCEDURE anonymised.anonymise_data()
    OWNER TO "cpSB74T20Z";
